    ...
    <aside class="sidebar-nav-wrapper">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li class="nav-item">
                    <a href="<?= base_url('/admin/buses') ?>" class="active">
                        <span class="icon"><i class="lni lni-bus"></i></span>
                ...
                <li class="nav-item">
                    <a href="<?= base_url('/admin/trajets') ?>">
                        <span class="icon"><i class="lni lni-road"></i></span>
