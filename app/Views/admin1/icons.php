  ...
  <body>
    ...
    <main class="main-wrapper">
      ...
      <section class="section">
        ...
        <a href="/admin/chauffeurs/add" class="btn btn-primary mb-3">Add Chauffeur</a>
    ...
    <tr>
        <td colspan="6">No chauffeurs found.</td>
    </tr>
<?php else: ?>
    <?php foreach ($chauffeurs as $chauffeur): ?>
        <tr>
            ...
            <td><?= $chauffeur['numTelephone'] ?></td>
            <td><?= $chauffeur['email'] ?></td>
            <td><?= $chauffeur['permis'] ?></td>
            <td>
                <a href="/admin/chauffeurs/edit/<?= $chauffeur['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                <a href="/admin/chauffeurs/delete/<?= $chauffeur['id'] ?>" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
    <?php endforeach; ?>
<?php endif; ?>
