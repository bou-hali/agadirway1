...
<!-- Table for displaying buses dynamically -->
<div class="tables-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <div class="card-style mb-30">
                <h6 class="mb-10">Bus Management</h6>
                <p class="text-sm mb-20">
                    Manage all the buses, their routes, and drivers.
                </p>
                            ...
                            <?php if (!empty($buses)): ?>
                                <?php foreach ($buses as $bus): ?>
                                    <tr>
                                        ...
                                        <td><?= $bus['bus_id'] ?></td>
                                        <td>
                                            <a href="<?= base_url('/admin1/buses/edit/' . $bus['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="<?= base_url('/admin1/buses/delete/' . $bus['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
